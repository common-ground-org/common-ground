...
export function PopoverForm({
  ...
  return (
    <div key={title} className="flex min-h-[100px] w-full items-center justify-center relative z-50">
      <motion.button
        layoutId={`${title}-wrapper`}
        onClick={() => setOpen(true)}
        style={{ borderRadius: 8 }}
        className="flex h-9 items-center border bg-white dark:bg-[#ffffff] px-3 text-sm font-medium outline-none"
      >
